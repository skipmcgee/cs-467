...
1.	Clone the Repo: git@github.com:skipmcgee/cs-467.git
a.	Alternatively, the HTTPS URL can be used instead of the SSH URL (if SSH keys are not configured with GitHub): git clone https://github.com/skipmcgee/cs-467.git
2.	Install Clippy: rustup component add clippy
a.	As a note: Clippy typically comes installed already!
...
a.	As a note: udev steps detailed in 'DEV_ENV_SETUP.md' does not apply to Windows. Please disregard udev steps during Picotool installation.
Troubleshooting:
